...
fun KisiEkleScreen(navController: NavController, id: Int? = null, viewModel: KisiEkleViewModel = hiltViewModel()) {
    ...
    if (id != null){
        ...
        var name by remember { mutableStateOf(kisi.name) }
        var phoneNumber by remember { mutableStateOf(kisi.phoneNumber) }
        ...
        Column(
            ...
            Button(
                onClick = {
                    val guncel_kisi = RehberModel(name, phoneNumber)
                    viewModel.saveData(guncel_kisi)
